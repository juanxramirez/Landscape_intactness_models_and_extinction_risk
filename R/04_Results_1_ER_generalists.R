...
# Number of threatened/non-threatened generalists
...
# Create data frame for xtinction risk (ER) models
...
pahipi.effectsize.table$habitat_breadth <- "Generalists"
rparhirpi.effectsize.table$land.model<-land.models
rparhirpi.effectsize.table$habitat_breadth <- "Generalists"

# Save effect sizes
write.table(pahipi.effectsize.table, file="effectsize_pahipi_generalists.csv", sep="\t", row.names=F)
write.table(rparhirpi.effectsize.table, file="effectsize_rparhirpi_generalists.csv", sep="\t", row.names=F)
...
effect.pahipi$habitat_breadth <- "Generalists"

# Save predicted probabilities
write.table(effect.pahipi, file="predicted_probability_pahipi_generalists.csv", sep="\t", row.names=F)
