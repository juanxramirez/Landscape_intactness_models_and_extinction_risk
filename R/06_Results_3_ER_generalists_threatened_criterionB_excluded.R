...
# Save effect sizes
write.table(pahipi.effectsize.table, file="effectsize_pahipi_generalists_threatened_criterionB_excluded.csv", sep="\t", row.names=F)
write.table(rparhirpi.effectsize.table, file="effectsize_rparhirpi_generalists_threatened_criterionB_excluded.csv", sep="\t", row.names=F)
